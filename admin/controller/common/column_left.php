	...
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            /*START OVICKO MULTISELLER*/
					// Seller
				$seller = array();
				if ($this->user->hasPermission('access', 'sale/seller')) {
					$seller[] = array(
				...
				if ($this->user->hasPermission('access', 'catalog/commission')) {
					$seller[] = array(
						'name'	   => $this->language->get('text_commission'),
						'href'     => $this->url->link('catalog/commission', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()		
					);
				}
				if ($this->user->hasPermission('access', 'catalog/sellerreview')) {		
					$seller[] = array(
						'name'	   => $this->language->get('text_sellerreview'),
						'href'     => $this->url->link('catalog/sellerreview', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()		
					);	
				}

...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		...
		if ($catalog) {                   
		 ...
		 // $seller_sales[] = array(
		 //     'name'  => $this->language->get('text_seller_returns'),
		 //     'href'  => $this->url->link('sellerproduct/product', '', 'SSL'),
		 //     'children' => array()
		 // );
		 // $seller_sales[] = array(
		 //     'name' => $this->language->get('text_seller_vouchers'),
		 //     'href' => $this->url->link('sellerproduct/downloads', '', 'SSL'),
		 //     'children' => array()       
		 // );
		 // $seller_sales[] = array(
		 //     'name'     => $this->language->get('text_seller_reviews'),
		 //     'href'     => $this->url->link('sellerproduct/reviews', '', 'SSL'),
		 //     'children' => array()       
		 // );
		 if ($seller_sales) {                   
		     $data['menus'][] = array(

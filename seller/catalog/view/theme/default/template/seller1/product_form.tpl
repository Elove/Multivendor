          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <ul class="nav nav-tabs" id="language">
                ...
                <li><a href="#language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="catalog/view/theme/default/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" 
					  value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>" placeholder="<?php echo $entry_tag; ?>" id="input-tag<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                </div>
                <?php } ?>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"> <?php echo $entry_retail_price ?></label>
                <div class="col-sm-10">
                  <input type="text" name="price" value="<?php echo $price ?>" placeholder="<?php echo $entry_retail_price ?>" id="input-price" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label" for="input-wholesale-price"><?php echo 
                 $entry_wholesale_price ?></label>
                 <div class="col-sm-10">
                   <input type="text" name="wholesale_price" value="<?php echo $wholesale_price ?>" 
                   placeholder="<?php echo $entry_wholesale_price ?>" id="input-wholesale-price" class="form-control" />
                 </div>
               </div>
               <div class="form-group">
                 <label class="col-sm-2 control-label" for="input-commission"><?php echo $entry_commission ?></label>
                 <div class="col-sm-4">
                      <select name="commission_type" id="input-commission" class="form-control" onchange="cc(this.value)">
                    <?php if ($commission_type == 'F') {?>
                    <option value="F" selected="selected"><?php echo $fixed_commission ?></option>
                    <?php } else { ?>
                    <option value="F" selected="selected"><?php echo $fixed_commission ?></option>
                    <?php } ?>
                    <?php if($commission_type == 'P') { ?>
                    <option value="P" selected="selected"><?php echo $percent_commission ?></option>
                    <?php } else { ?>
                    <option value="P"><?php echo $percent_commission ?></option>
                    <?php } ?>
                  </select>
                   </div>
                   <div class="col-sm-1" style="padding: 0px;width: 5px;float: left;display: block;" id="fixed_commission"><?php echo $store_currency;?></div>
                   <div class="col-sm-5" style="padding-left:4px;padding-right: 4px; float: left;display: block;" id="fixed_commission">
                     <input type="text" name="commission_value" value="<?php echo $commission_value ?>" placeholder="<?php echo $entry_commission ?>"
                     id="input-commission_price" class="form-control">
                   </div>
                   <div class="col-sm-1" style="padding: 0px;width: 5px;float: left;display: none;" id="percent_commission">%</div>
               </div>
              <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group date">
                            <input type="text" name="product_option[<?php echo $option_row; ?>][value]" value="<?php echo $product_option['value']; ?>" placeholder="<?php echo $entry_option_value; ?>"
							data-date-format="YYYY-MM-DD" id="input-value<?php echo $option_row; ?>" class="form-control" />
...
$('input[name=\'manufacturer\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=seller/extension/manuautocomplete&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				json.unshift({
					manufacturer_id: 0,
...
$("input#input-price").keyup(function(){
  //alert($("input#input-price").val());
  retailPrice = $("input#input-price").val();
});
$("input#input-wholesale-price").keyup(function(){
  //alert($("input#input-wholesale-price").val());
  wholeSalePrice = $("input#input-wholesale-price").val();
  if (retailPrice < wholeSalePrice) {
    alert("Retail price "+ retailPrice+" MUST be greater than Wholesale price");
  }
});
// if (retailPrice < wholeSalePrice) {
//   alert("Retail price "+ retailPrice+" MUST be greater than Wholesale price");
// }
// $("#input-commission").change(function(){
//  var commission_type = $("#input-commission").val();
//   //alert($("#input-commission").val());
//   wholeSalePrice = $("input#input-wholesale-price").val();
//   retailPrice = $("input#input-price").val();
//   //have the commission type
//   if(commission_type == 'F' && (retailPrice > wholeSalePrice)){
//   var fixed = retailPrice - wholeSalePrice;
//      $("#input-commission_price").val(fixed);
//     alert(retailPrice - wholeSalePrice);
//     return fixed;
//   }
//   if(commission_type == 'P' && (retailPrice > wholeSalePrice)){
//     var percent = ((retailPrice - wholeSalePrice)/retailPrice)*100;
//       $("#input-commission_price").val(percent);
//      alert(percent);
//     return percent;
//   }
// });
//extracted
 function cc(v){
    if(v== 'P'){
        $('#percent_commission').show();
        $('#fixed_commission').hide();
        getprice();
     }else {
         $('#fixed_commission').show();
        $('#percent_commission').hide();
         getprice();
     }
    }
      ...
      $("#input-wholesale-price").keyup( function() {
      getprice();
      });
    function getprice(){
    var commission_type = $("#input-commission").val();
    var error_price = "Retail price must be greater than Wholesale price";
    //alert($("#input-commission").val());
    wholeSalePrice = $("input#input-wholesale-price").val();
    retailPrice = $("input#input-price").val();
    //check for 
    $('.err').remove();
    if ((wholeSalePrice > retailPrice) || (wholeSalePrice == 0) ) {
     $('#input-price').after('<div style="color:red" class="err">'+error_price +'</div>');
     }
     else {
       ...
       if(commission_type == 'P'){
         var percent = ((retailPrice - wholeSalePrice)/retailPrice)*100;
           $("#input-commission_price").val(percent.toFixed(4));
          //alert(percent);

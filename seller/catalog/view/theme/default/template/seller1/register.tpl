        ...
        <fieldset id="account">
		 ...
		 <div class="form-group has-feedback required">
          ...
          <div class="form-group has-feedback required">
			...
			<div class="form-group" id="plan-tr">
            <label class="col-sm-3 control-label" for="input-plan">Select Plan</label>
            <div class="col-sm-8">
			  <select name="new_commission_id" class="form-control" >
		  <option value="">--Select Plan--</option>
		  <?php foreach ($ncommissions as $commission) { ?>
            <?php if ($commission['commission_id'] == $new_commission_id) {  ?>
            <option value="<?php echo $commission['commission_id']; ?>" selected="selected">
			<?php echo $commission['commission_name']; ?>(<?php echo $commission['amount1']; ?>)</option>
            <?php } else { ?>
             <option value="<?php echo $commission['commission_id']; ?>"><?php echo $commission['commission_name']; ?>
			 (<?php echo $commission['amount1']; ?>)</option>
            <?php } ?>
            <?php } ?>
			</select>
            </div>

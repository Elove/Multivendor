...
class ControllerInstallStep3 extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output .= 'define(\'HTTPS_CATALOG1\', \'' . HTTP_OPENCART . 'seller/\');' . "\n";
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_OPENCART . 'seller/\');' . "\n\n";
			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_OPENCART . 'seller/\');' . "\n\n";
			$output .= 'define(\'HTTP_SERVER1\', \'' . HTTP_OPENCART . '\');' . "\n\n";
			$output .= 'define(\'HTTPS_SERVER1\', \'' . HTTP_OPENCART . '\');' . "\n\n";
			$output .= '// DIR' . "\n";
	...
	private function validate() {
		...
		if (!is_writable(DIR_OPENCART . 'seller/config.php')) {
			$this->error['warning'] = $this->language->get('error_config') . DIR_OPENCART . 'seller/config.php!';
		}
